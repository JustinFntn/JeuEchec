...
/**
 * Cette classe permet de créer une pièce de type Tour
 * avec comme paramètre sa couleur et sa position.
 * Elle permet de gérer les déplacements possibles de la tour.
 */
public class Tour extends Piece {
    ...
    /**
     * constructeur par défaut de la classe Tour.
     * elle permet de créer une tour blanche en position A1.
     */
    public Tour() {
        super("B", "A1");
    }
     ...
     * elle permet de créer une tour avec comme paramètre sa couleur et
     ...
     */
    public Tour(String position, String couleur) {
        super(couleur, position);
    }
    ...
    /**
     * méthode qui permet de récupérer les déplacements possibles de la Tour.
     * 
